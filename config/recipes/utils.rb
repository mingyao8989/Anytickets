...
task :console, :roles => ENV['ROLE'] || :web do
  ...
  desc "Symlink the pictures directory into latest release"
  task :symlink_pictures, roles: :app do
    run "ln -nfs #{shared_path}/pictures #{release_path}/public/pictures"
  end
  after "deploy:finalize_update", "utils:symlink_pictures"
